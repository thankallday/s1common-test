...
// ----------------------------------------------------------------------------
/**
 * A non-shell profile tree node implementation. This implementation trades off some object orientation "niceness" to
 * achieve more memory compactness.
 * 
...
final class ObjectProfileNode extends AbstractProfileNode
{
  ...
  /*
   * This method is called once on every node to lock it down into its immutable and most compact representation during
   * phase 2 of profile tree construction.
   */
  void finish()
  {
