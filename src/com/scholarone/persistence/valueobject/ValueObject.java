// Source file: C:\\scholarone\\gus\\dev\\src\\com\\scholarone\\common\\ValueObject.java
...
import com.scholarone.cache.CacheKey;
...
import com.scholarone.persistence.validator.BasePersistenceValidator;
import com.scholarone.persistence.validator.PersistenceValidationException;
...
public class ValueObject extends Object implements Cloneable, Comparable, Serializable, CacheableObject
{
  ...
  public static final String DEFAULT_STRATEGY_CLASS_NAME = "com.scholarone.persistence.valueobject.StoredProcedurePersistence";
  ...
  public void setMode(byte mode)
  {
    ...
    if (log == null && mode == SERVER) log = Logger.getLogger(ValueObject.class);
  }
  ...
  public void save(Integer userId) throws PersistenceException
  {
    this.save(userId, getDefaultStrategy());
  }

  public void save(Integer userId, GenericPersistenceStrategy strategy) throws PersistenceException
  {
    this.save(userId, DEFAULT_SAVE, strategy);
  }

  public void save(Integer userId, String methodName) throws PersistenceException
  {
      ...
      throws PersistenceException
  {
    ...
    if (strategy == null)
    {
      ...
      if (strategy == null)
      {
        throw new PersistenceException("Cannot save without a persistence strategy");
      }
    }
    ...
    if ( this.getConfiguration() != null )
    {
      ...
      for (String validatorName : validators)
      {
        ...
        {
          PersistenceValidationException pve = new PersistenceValidationException("Persistence Security Violation: " + this.getClass().getName() + "["
  ...
  public Integer copy(Vector criteria)
  {
    ...
    {
      // report the error
      log.error("ValueObject.copy : error copying " + this.getClass().getName(), e);
    }

    return object;
  }

  public void delete(Integer userId) throws PersistenceException
  {
    this.delete(userId, getDefaultStrategy());
  }

  public void delete(Integer userId, GenericPersistenceStrategy strategy) throws PersistenceException
  {
    this.delete(userId, DEFAULT_SAVE, strategy);
  }

  public void delete(Integer userId, String methodName) throws PersistenceException
  {
  ...
  public ValueObject lazyLoadObject(String className, Vector criteria, String method)
  {
    ...
    {
      // report the error
      log.error("ValueObject.lazyLoadObject : error loading " + className + " using " + method, e);
    }
  ...
  protected ValueObjectList lazyLoadList(String className, Vector criteria, String method)
  {
    ...
    catch (ScholarOneException e)
    {
      ...
      // report the error
      log.warn("ValueObject.lazyLoadList : error loading " + className + " using " + method, e);
  ...
  public static GenericPersistenceStrategy getDefaultStrategy()
  {
    synchronized(defaultStrategyLock)
    {
      if (defaultStrategy == null)
      {
        try
        {
          defaultStrategy = com.scholarone.persistence.valueobject.ValueObjectFactory.getInstance().createStrategy(DEFAULT_STRATEGY_CLASS_NAME);
          System.out.println("ValueObject.getDefaultStrategy : successfully created " + DEFAULT_STRATEGY_CLASS_NAME);
        }
        catch (ObjectCreationException oce)
        {
          // report the error
          log.error("ValueObject.useStrategy : could not create " + DEFAULT_STRATEGY_CLASS_NAME, oce);
  ...
  public ValueObjectConfiguration getConfiguration()
  {
    ...
    try
    {
      configuration = com.scholarone.persistence.valueobject.ValueObjectFactory.getInstance().getObjectConfiguration(
          this.getClass());
    }
    catch (ObjectCreationException oce)
    {
  ...
  protected Timestamp xmlString2Timestamp(String str) throws ScholarOneException
  {
    try
    {
    ...
    {
      throw new ScholarOneException(e);
    }
  }
   ...
   */
  protected String timestamp2XmlString(Timestamp time) throws ScholarOneException
  {
    try
    {
