...
public class ValueObjectConfiguration implements Serializable
{
  ...
  {
    log = Logger.getLogger(ValueObjectConfiguration.class);
  ...
  public FinderMethod getFinderMethod(String name) throws PersistenceException
  {
    if (!finderMethodMap.containsKey(name))
    {
      throw new PersistenceException("Cannot find method named: " + name);
    }

    return (FinderMethod) finderMethodMap.get(name);
  }

  public SaveMethod getSaveMethod(String name) throws PersistenceException
  {
    if (!saveMethodMap.containsKey(name))
    {
      throw new PersistenceException("Cannot find method named: " + name + " for type " + getType());
    }
  ...
  public void addStoredProcedureResult(String name)
  {
    ...
    {
      log.info("Catching exception in  ValueObjectConfiguration", e);
    }
