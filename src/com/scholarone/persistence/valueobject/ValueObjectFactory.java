...
import com.scholarone.cache.CacheManager;
import com.scholarone.cache.CacheTimeManager;
...
public class ValueObjectFactory
{
  ...
  protected ValueObjectFactory()
  {
    ...
    if (log == null) log = Logger.getLogger(ValueObjectFactory.class);
  }

  public synchronized void flush()
  {
    log.debug("Entering ValueObjectFactory.flush");

    System.out.println("[JBOSS] ValueObjectFactory.flush");
  }

  public ValueObject createObjectFromConfig(ValueObjectConfiguration config) throws ObjectCreationException
  {
    ...
    {
      throw new ObjectCreationException("Cannot create ValueObject: " + iae.toString());
    }
    catch (InstantiationException ie)
    {
      throw new ObjectCreationException("Cannot create ValueObject: " + ie.toString());
    }
  ...
  * 
  */
  public GenericPersistenceStrategy createStrategy(String className) throws ObjectCreationException
  {
    ...
    try
    {
      log.debug("Entering ValueObjectFactory.createStrategy(" + className + ")");
    ...
    {
      throw new ObjectCreationException("Cannot create strategy: " + cnfe.toString());
    }
    catch (IllegalAccessException iae)
    {
      throw new ObjectCreationException("Cannot create strategy: " + iae.toString());
    }
    catch (InstantiationException ie)
    {
      throw new ObjectCreationException("Cannot create strategy: " + ie.toString());
    }

    return strategy;
  }

  public ValueObjectConfiguration getObjectConfiguration(String className) throws ObjectCreationException
  {
//    log.debug("Entering ValueObjectFactory.getObjectConfiguration");
    ...
    {
      throw new ObjectCreationException("Cannot find class " + className + ": " + cnfe.toString());
    }
  }

  public ValueObjectConfiguration getObjectConfiguration(Class type) throws ObjectCreationException
  {
  ...
  public ValueObject findObjectByCriteria(String typeName, Vector criteria, String finderName)
      throws ObjectCreationException, PersistenceException
  {
      ...
      throws ObjectCreationException, PersistenceException
  {
    ...
    if ( config.useCache() && useCache )
    {
      ...
      {
        log.error("Cannot find class " + typeName, cnfe);
      }
  ...
  public Integer copy(String className, Vector criteria) throws ScholarOneException
  {
//    log.debug("Entering ValueObjectFactory.copy");
   ...
   */
  public ValueObjectList findListByCriteria(String typeName, Vector criteria, String finderName, boolean useCache,
      byte scope) throws ObjectCreationException, PersistenceException
  {
   ...
   */
  public ValueObjectList findListByCriteria(String typeName, Vector criteria, String finderName, boolean useCache,
      byte scope, String strategyClassName) throws ObjectCreationException, PersistenceException
  {
      ...
      for( Object o : list )
      {
        ...
        if ( vo != null && vo.getConfiguration() != null )
        {
          ...
          for (String validatorName : validators)
          {
            ...
            {
              PersistenceValidationException pve = new PersistenceValidationException("Persistence Security Violation: " + vo.getClass().getName()
                  + " using " + finderName);
              pve.printStackTrace();
