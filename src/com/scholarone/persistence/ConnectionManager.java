...
public class ConnectionManager
{
  ...
  private ConnectionManager()
  {
    ...
    if (log == null)
    {
      log = Logger.getLogger(ConnectionManager.class);
    }
    ...
    {
      if (log != null) log.error("ConnectionManager: Could not create InitialContext() in constructor", e);
    }
      ...
      if (connection == null)
      {
        ...
        if (source != null)
        {
          ...
          catch (Throwable t)
          {
            ...
            log.warn("ContextManager.openConnection - could not find connection pool for cached datasource - "
                + sourceName, t);
          }
        }
        ...
        if (connection == null)
        {
          log.error("ConnectionManager.openConnection: data source getConnection returned null");
          return null;
        }
        ...
        {
          log.error("Exception in ConnectionManager.openConnection", e);
  ...
  public boolean closeConnection(Connection connection)
  {
    ...
    if (connection != null)
    {
      if (connection != getCurrentTxConnection())
      {
        ...
        {
          log.error("SQLPersistence:closeConnection - close: " + se.getMessage(), se);
        }
