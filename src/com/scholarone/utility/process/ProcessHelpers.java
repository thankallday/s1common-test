package com.scholarone.utility.process;
...
import com.scholarone.persistence.valueobject.ValueObjectFactory;
import com.scholarone.persistence.valueobject.XMLPersistence;
...
public class ProcessHelpers
{
  ...
  {
    // Output as UTF-8...
    S3File outputFile = new S3File(fileName);
    PrintWriter pw = new PrintWriter(new OutputStreamWriter(new S3FileOutputStream(outputFile), "UTF-8"));
