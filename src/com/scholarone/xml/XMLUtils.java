...
public class XMLUtils
{
   ...
   * 
   */
  public static SAXParserFactory newParserFactory() throws XMLConfigurationException
  {
   ...
   * 
   */
  public static SAXParserFactory newParserFactory(int validationType) throws XMLConfigurationException
  {
    try
    {
    ...
    {
      throw new XMLConfigurationException("XML parser factory has not been " + "configured correctly: "
          + e.getMessage());
    }
  }
   ...
   */
  public static XMLReader getXMLReader() throws XMLConfigurationException
  {
   ...
   * @return a SAX 2 XMLReader.
   */
  public static XMLReader getXMLReader(int validationType) throws XMLConfigurationException
  {
    try
    {
    ...
    {
      throw new XMLConfigurationException(e.toString());
    }
  }
   ...
   */
  private static SAXParser newSAXParser(int validationType) throws XMLConfigurationException
  {
    try
    {
    ...
    {
      throw new XMLConfigurationException("Cannot create parser for the given " + "configuration: " + e.getMessage());
    }
    catch (SAXNotRecognizedException x)
    {
      // Happens if the parser does not support JAXP 1.2
      throw new XMLConfigurationException(x.toString());
    }
    catch (SAXException e)
    {
      throw new XMLConfigurationException(e.toString());
   ...
   */
  public static InputSource getConfigInputSource(Object forWhom) throws XMLConfigurationException
  {
    ...
    if (inStream == null)
    {
      throw new XMLConfigurationException("Unable to find config file " + fileName + " for class " + className);
    }
  ...
  public static String getConfigFileName(Object forWhom)
  {
    ...
    String className = inClass.getName().replace('.', S3File.separatorChar);
  ...
  public static boolean applyXSLTransform(Source input, Result output, Source styleSheet)
  {
    ...
    {
      log.info("Exception caught in XMLUtils.applyXSLTransform: ", te);
      success = false;
    }
