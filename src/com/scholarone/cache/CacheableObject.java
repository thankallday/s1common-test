...
/**
 * This interface describes the aspects a class must have in order to be stored in a cache and looked up using a
 * CacheKey.
 */
public interface CacheableObject
{
   ...
   */
  public void setCacheLongevity(byte scope) throws PersistenceException;
