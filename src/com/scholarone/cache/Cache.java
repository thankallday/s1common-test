...
import com.scholarone.context.ICallContext;
import com.scholarone.context.ThreadLocalContext;
...
public class Cache
{
  ...
  public Cache(Integer stackId)
  {
    ...
    log = Logger.getLogger(Cache.class);
  ...
  public void put(CacheKey key, CacheableObject object)
  {
    if ((object != null) && (object.isCacheable()))
    {
      ...
      else
      {
        ...
        log.debug("Cache[" + stackId + "] put - " + primary + ", " + object.getClass().getName());
      ...
      if (secondary != null)
      {
        ...
        log.debug("Cache[" + stackId + "] put - " + secondary + ", " + object.getClass().getName());
      ...
      if ((key != null) && (!cacheMap.containsKey(key.toString())))
      {
        ...
        log.debug("Cache[" + stackId + "] put - " + key + ", " + object.getClass().getName());
   ...
   * updated.
   */
  public CacheableObject get(CacheKey key) throws ObjectCreationException, PersistenceException
  {
    if (key == null)
    {
      return null;
    ...
    log.debug("Cache[" + stackId + "] get - " + key.toString());
    ...
    if ((item == null) || (item.getObject() == null))
    {
      ...
      if (gen != null)
      {
        log.debug("Cache[" + stackId + "] regenerate - " + key.toString());
  ...
  public void regenerate(CacheKey key)
  {
    ...
    {
      log.error("Error regenerating object", e);
    }
  }
  ...
  public void flush(CacheKey key, boolean recursive)
  {
    ...
    log.debug("Cache[" + stackId + "] flush - " + key.toString());
  ...
  public void flush(CachePointer pointer, boolean recursive)
  {
    if (pointer != null)
    {
      ...
      while (it.hasNext())
      {
        ...
        log.debug("Cache[" + stackId + "] flush - " + object.toString());
