...
/**
 * This class encapsulates a generic set of criteria to be used for finding objects in a cache. Each CacheCriteria
 * object holds an internal array of objects. Hashcode and equals methods are based on the values of the objects in the
 * array.
 * 
 * It is possible to create a CacheCriteria with no criteria by passing null to a constructor. Such CacheCriteria will
 * use Object.hashcode() and Object.equals() values.
 * 
 * @author Ken Kelley
 */
