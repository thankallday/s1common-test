...
/**
 * This class represents the public interface to the cache. It is implemented as a singleton.
 */
public class CacheManager
{
  ...
  {
    log = Logger.getLogger(CacheManager.class);
   ...
   */
  public CacheableObject get(CacheableObject object) throws ObjectCreationException, PersistenceException
  {    
   ...
   */
  public CacheableObject get(String className, Integer id) throws ObjectCreationException, PersistenceException
  {
