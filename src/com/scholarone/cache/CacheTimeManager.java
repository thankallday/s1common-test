...
import com.scholarone.utility.process.ProcessHelpers;

/**
 * Manages the TimeLists for a cache. Handles checking them for objects that have expired and flushing those objects
 * from the cache.
 */
public class CacheTimeManager
{
  ...
  {
    log = Logger.getLogger(CacheTimeManager.class);
    try
    {
/*      cacheObjectName = new javax.management.ObjectName("com.scholarone.mc:name=CacheTimeManagerMBean");
    ...
    {
      log.error("error setting up new JMX CacheTimeManager", t);
    }
    if (cacheMBean != null)
    {
