...
/**
 * An object that can be held in the cache. Each time it is accessed, it keeps track of the time it was accessed. This
 * is used by the TimeList class to tell whether it should be expired.
 * 
 * Note: the variables/accessors for createdTime and accessCount were removed as they are unused. They can be
